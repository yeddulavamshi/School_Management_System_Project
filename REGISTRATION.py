...
firstw=Tk()
firstw.title("SHREE VAMSHI KRISHNA PLAY SCHOOL")
firstw.geometry("1600x1000+0+0")
label=Label(text="SHREE VAMSHI KRISHNA KIDS PLAY SCHOOL",font=("times new roman",35),bg="MediumOrchid2")
...
def second():
    global secondw
    secondw=Tk()
    secondw.title("KRISHNA KIDS PLAY SCHOOL")
    ...
    def distroy5():
        secondw.destroy()
        window()
    mainlabel= Label(secondw,text="SHREE VAMSHI KRISHNA KIDS PLAY SCHOOL", font=("times new roman", 35), bg="MediumOrchid2")
    mainlabel.pack(side=TOP, fill=X)
...
def root():
    ...
    root.title("SHREE VAMSHI KRISHNA PLAY SCHOOL")
    global entry1
    global entry2
    global entry3
    global entry4
